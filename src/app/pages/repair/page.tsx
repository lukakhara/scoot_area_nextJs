import desktopImage from "../../public/repairDes.png";
import mobileImage from "../../public/repairMob.png";
  ...
  return (
    <div className="mx-auto max-w-[1400px] px-5 pt-8 pb-16 lg:pt-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8.5">
        <picture>
          <source src={mobileImage} media="(min-width : 768px)" />
          <img src={desktopImage} alt="repairing image" />
        </picture>
