...
import hemetDesktop from "../../public/helmetDesktop.png";
import helmetMobile from "../../public/helmetMobile.png";
import landingPageDesktop from "../../public/langindPageBgMobile.png";
import landingPageMobile from "../../public/langindPageBgDesktop.png";
import bannerDesktop from "../../public/landingPageBannerDesktop.png";
import bannerMobile from "../../public/landingPageBannerMobile.png";
import blogDesktop from "../../public/blogDesktop.png";
import blogMobile from "../../public/blogMobile.png";
import serviceDesktop from "../../public/langindPageServiceDesktop.png";
import serviceMobile from "../../public/langindPageServiceMobile.png";
  ...
  return (
    <div className="min-h-screen bg-background  ">
      ...
      <section className="grid *:col-start-1 *:row-start-1 justify-between ">
        <picture>
          <source media="(min-width: 768px)" srcSet={landingPageMobile} />
          <img
            ...
            <div className="flex flex-col items-stretch gap-8.75  md:flex-row w-full justify-center ">
              ...
              <div className="relative w-full xl:max-w-[853px] flex-shrink-0 self-stretch min-h-0">
                <picture className="block w-full h-full">
                  <source media="(min-width: 768px)" srcSet={serviceDesktop} />
                  <img
                    src={serviceMobile}
          ...
          {[0, 1].map((i) => (
            ...
            >
              <div className="relative ">
                <picture className=" block w-full h-full">
                  <source media="(min-width: 768px)" srcSet={blogDesktop} />
                  <img
                    src={blogMobile}
