...
import helmetMobile from "../../public/productDesk.png";
import helmetDesktop from "../../public/productDesk.png";
import productBatteryDesktop from "../../public/productBatteryDesk.png";
import productBatteryMobile from "../../public/productBatteryMob.png";

const SIMILAR: Product[] = Array.from({ length: 6 }, () => ({
  productType:'parts',
  title: "Ninebot by Segway - F30 Plus",
  price: "750.00₾",
  imageLabel: "battery",
  imagePath: {
    mobile: productBatteryMobile,
    desktop: productBatteryDesktop,
  },
}));
