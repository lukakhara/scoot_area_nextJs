...
const LOCATIONS = [
  {
    title: "სათაო ოფისი",
    hours: "ორშაბათი–შაბათი | 10:00 – 18:00",
    address: (
      <>
        რუსთაველის გამზ. 10
        <br />
...
const ContactPage = () => {
  return (
    <div className="mx-auto max-w-[1400px] px-5 py-12 flex flex-col gap-4">
      ...
      <div className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-full bg-gray-300 flex items-center gap-4 py-6 px-22">
      ...
      <div>
        {LOCATIONS.map(({ title, hours, address }, idx) => (
          <section key={idx} className={idx === 0 ? "pt-10" : ""}>
